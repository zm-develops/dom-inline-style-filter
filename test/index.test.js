['code', 'wiki'].forEach(image => {
	...
	const computedStylesFn = getCachedDeclaration(el => globalThis.getComputedStyle(el));
	...
	globalThis.dominlinestylefilter(root, { debug: true });
	...
	for (const line of buffer.map(String)) {
